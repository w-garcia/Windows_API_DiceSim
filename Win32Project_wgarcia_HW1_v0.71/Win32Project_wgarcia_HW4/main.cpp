...
public:
	...
	double getPolarRadius(double xr, double yr); //returns polar radius given two values, unusued
...
double Domino::getPolarRadius(double xr, double yr) //unused function
{
